...
const TermsConditions = () => {
  return (
    <section id="terms__condition">
      <div className="container privacy__container term_c-container">
        <h1 className="heading">Terms & conditions</h1>
        <p className="text">Last updated October 29, 2023</p>

        <div className="first__div">
          <h6 className="sub__heading">1. AGREEMENT TO TERMS</h6>

          <p className="text">
            These Terms and Conditions constitute a legally binding agreement
            made between you, whether personally or on behalf of an entity
            (“you”) and AI Audits inc (“Company“, “we”, “us”, or “our”),
            concerning your access to and use of the https://www.gowinston.ai
            website as well as any other media form, media channel, mobile
            website or mobile application related, linked, or otherwise
            connected thereto (collectively, the “Site”). We are registered in
            Canada and have our registered office at 215 Avenue du Mont-Royal O,
            Montréal, QC H2T 2T2, Canada, Montréal H2T 2T2. You agree that by
          ...
          <p className="text">
            ...
            changes or modifications to these Terms and Conditions from time to
          ...
          <h6 className="sub__heading">2. INTELLECTUAL PROPERTY RIGHTS</h6>
          ...
          <h6 className="sub__heading">3. USER REPRESENTATIONS</h6>
          ...
          <p className="text">
            ...
            and Conditions; (4) you are not under the age of 13; (5) you are not
            a minor in the jurisdiction in which you reside, or if a minor, you
            have received parental permission to use the Site; (6) you will not
          ...
          <h6 className="sub__heading">4. USER REGISTRATION</h6>
          ...
          <h6 className="sub__heading">5. FEES AND PAYMENT</h6>
          ...
          <div className="notice">
            ...
            <div className="circle__div">
              <div className="circle"></div>
              <p className="text">Mastercard</p>
            </div>
            <div className="circle__div">
              <div className="circle"></div>
              <p className="text">American Express</p>
            </div>
            <div className="circle__div">
              <div className="circle"></div>
          ...
          <h6 className="sub__heading">6. FREE TRIAL</h6>

          <p className="text">
            We offer a 7-day free trial to new users who register with the Site.
          ...
          <h6 className="sub__heading">7. CANCELLATION</h6>

          <p className="text">
            All purchases are non-refundable. You can cancel your subscription
            at any time by logging into your account or contacting us using the
          ...
          <h6 className="sub__heading">8. PROHIBITED ACTIVITIES</h6>
          ...
          <p className="text">As a user of the Site, you agree not to:</p>
          ...
          <div className="notice">
            ...
            <div className="circle__div">
              <div className="circle"></div>
              <p className="text">Sell or otherwise transfer your profile.</p>
            </div>
          </div>

          <h6 className="sub__heading">9. USER GENERATED CONTRIBUTIONS</h6>
          ...
          <h6 className="sub__heading">10. CONTRIBUTION LICENSE</h6>
          ...
          <h6 className="sub__heading">11. GUIDELINES FOR REVIEWS</h6>
          ...
          <h6 className="sub__heading">12. SOCIAL MEDIA</h6>
          ...
          <h6 className="sub__heading">13. SUBMISSIONS</h6>
          ...
          <h6 className="sub__heading">14. THIRD-PARTY WEBSITES AND CONTENT</h6>
          ...
          <h6 className="sub__heading">15. ADVERTISERS</h6>
          ...
          <h6 className="sub__heading">16. U.S. GOVERNMENT RIGHTS</h6>
          ...
          <p className="text">
            ...
            (“DOD”), our services are subject to the terms of these Terms and
            Conditions in accordance with FAR 12.212 (for computer software) and
            FAR 12.211 (for technical data). If our services are acquired by or
            on behalf of any agency within the Department of Defense, our
            ...
            technical data under these Terms and Conditions.
          </p>

          <h6 className="sub__heading">17. SITE MANAGEMENT</h6>
          ...
          <h6 className="sub__heading">18. PRIVACY POLICY</h6>

          <p className="text">
            We care about data privacy and security. Please review our Privacy
            Policy: https://audits.ai/privacy-policy/. By using the Site, you
            ...
            Canada. If you access the Site from any other region of the world
            with laws or other requirements governing personal data collection,
            use, or disclosure that differ from applicable laws in Canada, then
            ...
            processed in Canada. Further, we do not knowingly accept, request,
          ...
          <h6 className="sub__heading">19. TERM AND TERMINATION</h6>
          ...
          <h6 className="sub__heading">20. MODIFICATIONS AND INTERRUPTIONS</h6>
          ...
          <h6 className="sub__heading">
            21. API Users Obligations and Disclaimer
          </h6>

          <p className="text">
            By accessing and utilizing the AI Audits API, you acknowledge and
            agree to be bound by the same Terms and Conditions that govern the
            use of our software, AI Audits. It is imperative to review these
            Terms and Conditions carefully. As an API user, you are subject to
            the same obligations, responsibilities, and restrictions outlined
            herein.
          </p>

          <p className="text">
            While we strive to maintain a high level of service availability,
            with a targeted uptime of 99.9%, please note that occasional
            downtime may occur due to unforeseen circumstances, maintenance, or
            factors beyond our control. Therefore, we cannot be held responsible
            for any losses, damages, or missed opportunities resulting from such
            incidents. This includes, but is not limited to, any financial
            losses, revenue reduction, or other adverse effects arising from the
            unavailability of the API.
          </p>

          <p className="text">
            We highly recommend API users to have appropriate contingency plans
            in place and take necessary precautions to mitigate any potential
            risks associated with service interruptions or downtime. We shall
            not be held liable for any indirect, consequential, or incidental
            damages resulting from the use or reliance on the AI Audits API,
            regardless of the cause.
          </p>

          <p className="text">
            By continuing to use the AI Audits API, you acknowledge that you
            have read, understood, and agreed to these terms and conditions,
            acknowledging the inherent risks associated with software
            utilization and agreeing to indemnify and hold AI Audits and its
            affiliates harmless from any claims, damages, or losses arising from
            the use of our API.
          </p>

          <p className="text">
            If you do not agree with these terms, please refrain from accessing
            or utilizing the AI Audits API.
          </p>

          <h6 className="sub__heading">22. GOVERNING LAW</h6>

          <p className="text">
            These Terms shall be governed by and defined following the laws of
            Canada. AI Audits inc and yourself irrevocably consent that the
            courts of Canada shall have exclusive jurisdiction to resolve any
            dispute which may arise in connection with these terms.
          </p>

          <h6 className="sub__heading">23. DISPUTE RESOLUTION</h6>
          ...
          <p className="text">
            ...
            arbitration shall be Montreal, Canada. The language to be used in
          ...
          <h6 className="sub__heading">24. CORRECTIONS</h6>
          ...
          <h6 className="sub__heading">25. DISCLAIMER</h6>
          ...
          <h6 className="sub__heading">26. LIMITATIONS OF LIABILITY</h6>

          <p className="text">
            If AI Audits plagiarism check service detects a copy of your text
            that is not, in fact, plagiarized, AI Audits will not be held
            accountable or responsible. Before taking any action, you should
            directly compare any content that has been detected as a duplicate
            of yours to see if it truly is the same.
          </p>

          <p className="text">
            You understand and agree that when you use AI Audits detection
            service, you will be given a score between 0 and 100 indicating how
            likely it is that the content you have scanned was written using one
            of the prevalent ChatGPT, GPT-3, GPT-4, Bard, or Claude based AI
            writers. You realize and acknowledge that a score of 90, for
            instance, indicates that our AI detection tool will mistakenly label
            information as possibly artificial intelligence-generated 1 time out
            of every 10.
          </p>

          <p className="text">
            You accept and agree that the sole guarantee we offer in relation to
            our AI detection tool is that you will receive an evaluation of the
            likelihood that scanned text was produced using AI. The accuracy of
            the returned result (degree of probability) is not guaranteed by us.
            New and better generative AI writing tools are released on a regular
            basis. We make an effort to significantly enhance our AI detection
            techniques, but we cannot promise that we will be successful. If
            this is the case, the outcome of an AI detection check might be that
            it is impossible to tell whether scanned text was produced using AI.
          </p>

          <p className="text">
          AI Audits cannot be held accountable or responsible for any actions
            taken or not taken based on a reported score, whether the score is
            0% or 100%, because its AI detection service simply reports a
            probability. If a Human Score leads you to believe that some text
            was produced by AI, you should not take the probability as a fact.
            Investigate the situation by requesting research notes, early
            draughts, or the revision history from the content provider, for
            instance.
          </p>

          <p className="text">
            Occasional biases may be observed in results for non-native English
            speakers, owing to the inherent characteristics of Large Language
          ...
          <h6 className="sub__heading">27. INDEMNIFICATION</h6>
          ...
          <p className="text">
            ...
            use of the Site; (2) breach of these Terms and Conditions; (3) any
            breach of your representations and warranties set forth in these
            Terms and Conditions; (4) your violation of the rights of a third
          ...
          <h6 className="sub__heading">28. USER DATA</h6>
          ...
          <h6 className="sub__heading">30. CALIFORNIA USERS AND RESIDENTS</h6>
          ...
          <h6 className="sub__heading">31. MISCELLANEOUS</h6>
          ...
          <p className="text">
            AI Audits may use your Company Names and Logos in case studies,
            promotional materials, or other write-ups, unless you request
            otherwise.
          </p>

          <h6 className="sub__heading">32. CONTACT US</h6>
          ...
          <p className="text">
            215 Avenue du Mont-Royal O, Montréal, QC H2T 2T2, Canada
          </p>

          <p className="text">support@audits.ai</p>
        </div>
      </div>
    </section>
  );
